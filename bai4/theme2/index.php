...
if(isset($_POST['sbm'])){
    ...
    // update json 
    $arr_json[$book]=$file ; 
    $json_encode = json_encode($arr_json, JSON_UNESCAPED_UNICODE); 
       //pull json 
                        ...
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                   ...
                                   foreach($arr_json as $book=>$file ){
                                    ...
                                    <td class="text-center"><a href="dow.php?file=<?php echo $file; ?> "><i class="fa fa-download"></i></a></td>
                                </tr>
                                <?php  }  ?>
      ...
      <div class="modal-body">
       ...
       <form action="#" method="POST" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" name="book" placeholder=" nhập tên sách">
          </div>
          <div class="form-group">
            <label for="fileupload">Tải sách lên:</label>
           <input type="file" class="form-control-file border" id="fileupload" name="file">
          </div>
          <button id="add-book" type="submit" class="btn btn-primary" name="sbm" value="tải">Thêm sách</button>
        </form> 
